...
const DateEntry = ({ date, entriesForDate }: DateEntryProps) => {
  ...
  return (
    <div className='layout flex flex-col lg:flex-row gap-6 md:gap-12 font-mono w-full bg-white rounded-xl border border-blue-800 py-6'>
      <div className='w-full md:w-1/4 flex justify-between around'>
